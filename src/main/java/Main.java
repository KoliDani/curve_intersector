...
public class Main {
    public static void main(String[] args) {
        ...
        Line l1 = Line.create(new Point(-2,0), new Point(12,0));
        Line l2 = Line.create(new Point(5,10), new Point(5,-10));
        Arc a1 = Line.create(new Point(0,0), new Point(5,5), new Point(5,0));
